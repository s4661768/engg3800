 ...
 *      Author: mauro
 *
 *  licensing: https://github.com/maudeve-it/ILI9163-XPT2046-STM32/blob/c097f0e7d569845c1cf98e8d930f2224e427fd54/LICENSE
 *
...
#ifndef __Z_DISPL_ILI9163_H
#define __Z_DISPL_ILI9163_H
...
#define BKLIT_CCR					CCR1			//Capture-compare register
 ...
 ***************************************************/
#ifdef ILI9341
#define DISPL_WIDTH  128	//128	// 0 orientation //240
#define DISPL_HEIGHT 160	//160	// 0 orientation //320
#endif
#ifdef ILI9488
...
/**********************************
/ ILI9163 LCD family commands
 **********************************/
#define ILI9163_SLEEP_OUT			0x11	//wake up display
#define ILI9163_DISPLAY_ON			0x29	// enable display
#define ILI9163_PIXEL_FORMAT    	0x3A	// RGB565/RGB666/...
#define ILI9163_RGB_INTERFACE   	0xB0	// type of communication (full duplex, half, etc.)
#define ILI9163_MEMWR				0x2C	// writes into memory
#define ILI9163_COLUMN_ADDR			0x2A	// set area display to write into
#define ILI9163_PAGE_ADDR			0x2B	// set area display to write into
#define ILI9163_MADCTL				0x36	// order followed writing into memory (-> screen orientation)
#define ILI9163_MADCTL_0DEG 		0X88	// parameter of MADCTL command
#define ILI9163_MADCTL_90DEG 		0xE8	// parameter of MADCTL command
#define ILI9163_MADCTL_180DEG 		0x48	// parameter of MADCTL command
#define ILI9163_MADCTL_270DEG 		0x28	// parameter of MADCTL command

#define ILI9163_INIT_SHORT_DELAY	5		// Hal_Delay parameter
#define ILI9163_INIT_LONG_DELAY		150		// Hal_Delay parameter
...
Displ_Orientat_e Displ_Current_Or(void);
